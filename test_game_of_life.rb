...
require_relative 'neighbor_hood'
...
describe NeighborHood do
  ...
  it 'neighborhood with two alive cells as neighbors will stay alive in the next generation' do
    #skip
  ...
  it 'numbers of neighbors is 2 for a north west cell that has a neighbor in north and west' do
  ...
  it 'number of neighbors is 3 for a north west cell that has a neighbor in north, west and
center' do
    c1 = Cell.new(Location::NORTHWEST)
    c2 = Cell.new(Location::NORTH)
    c3 = Cell.new(Location::WEST)
  ...
  it 'number of neighbors is 3 for a south west cell that has a neighbor in east, center and
south' do
